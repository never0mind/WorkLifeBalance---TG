...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        "Привет! Я бот, который помогает отслеживать нагрузку, отдых и небольшие паузы в течение дня ☺️\n\n"
        "Как всё устроено:\n\n"
        "1️⃣ Утром и днём я буду присылать тебе короткие сообщения — поддержку или небольшой совет."
        "Ты сможешь оценить сообщение по шкале от 1 до 5 или нажать кнопку «Сделал паузу — помогло»\n\n"
        "Если нажмёшь, я спрошу, какой именно отдых тебе помог (прогулка, сон, друзья и т.д.) 🧸\n\n"
        "2️⃣ Вечером я напомню подвести итоги дня: оценить настроение, нагрузку и продуктивность,"
        "а при желании — записать короткую заметку 🎀\n\n"
        "3️⃣ В конце вечернего чек-ина я предложу запланировать 10 минут для себя на завтра — в удобное для тебя время 🙂\n\n"
        "4️⃣ Раз в неделю я буду присылать небольшой отчёт: сколько было вечерних отчетов, какое в среднем настроение "
        "и нагрузка, как часто помогали паузы и какой тип отдыха срабатывал лучше всего 🍪"
    )
